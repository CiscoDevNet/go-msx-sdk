...
type Service struct {
	...
	ProvisionedOn NullableTime `json:"provisionedOn,omitempty"`
...
// GetProvisionedOn returns the ProvisionedOn field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Service) GetProvisionedOn() time.Time {
	if o == nil || o.ProvisionedOn.Get() == nil {
		var ret time.Time
		return ret
	}
	return *o.ProvisionedOn.Get()
}
...
// SetProvisionedOn gets a reference to the given NullableTime and assigns it to the ProvisionedOn field.
func (o *Service) SetProvisionedOn(v time.Time) {
	o.ProvisionedOn.Set(&v)
}
// SetProvisionedOnNil sets the value for ProvisionedOn to be an explicit nil
func (o *Service) SetProvisionedOnNil() {
	o.ProvisionedOn.Set(nil)
}
...
func (o Service) MarshalJSON() ([]byte, error) {
	...
	if o.ProvisionedOn.IsSet() {
		toSerialize["provisionedOn"] = o.ProvisionedOn.Get()
	}
	if o.Status != nil {
