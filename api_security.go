...
*/
func (a *SecurityApiService) GetAccessToken(ctx context.Context) ApiGetAccessTokenRequest {
	return ApiGetAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return AccessToken
func (a *SecurityApiService) GetAccessTokenExecute(r ApiGetAccessTokenRequest) (*AccessToken, *http.Response, error) {
	var (
