...
func (r ApiGetDevicesHealthListRequest) Execute() ([]ResourceHealth, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *HealthApiService) GetDevicesHealthListExecute(r ApiGetDevicesHealthListRequest) ([]ResourceHealth, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if len(*r.ids) < 1 {
		executionError.error = "ids must have at least 1 elements"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiGetServicesHealthListRequest) Execute() ([]ResourceHealth, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return []ResourceHealth
 */
func (a *HealthApiService) GetServicesHealthListExecute(r ApiGetServicesHealthListRequest) ([]ResourceHealth, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
