...
func (r ApiExportWorkflowRequest) Execute() (string, *_nethttp.Response, error) {
...
func (a *WorkflowsApiService) ImportWorkflowExecute(r ApiImportWorkflowRequest) (WorkflowMapping, *_nethttp.Response, error) {
	...
	localVarFormParams := _neturl.Values{}
	if r.tenantIds == nil {
		return localVarReturnValue, nil, reportError("tenantIds is required and must be specified")
	}
