...
// GetPasswordPolicyName returns the PasswordPolicyName field value if set, zero value otherwise.
func (o *User) GetPasswordPolicyName() string {
	if o == nil || o.PasswordPolicyName == nil {
		var ret string
		return ret
	}
...
// GetPasswordPolicyNameOk returns a tuple with the PasswordPolicyName field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPasswordPolicyName gets a reference to the given string and assigns it to the PasswordPolicyName field.
