...
type SiteUpdate struct {
	...
	ManagingControlPlaneId NullableString `json:"managingControlPlaneId,omitempty"`
...
// GetManagingControlPlaneId returns the ManagingControlPlaneId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SiteUpdate) GetManagingControlPlaneId() string {
	if o == nil || o.ManagingControlPlaneId.Get() == nil {
		var ret string
		return ret
	}
	return *o.ManagingControlPlaneId.Get()
}

// GetManagingControlPlaneIdOk returns a tuple with the ManagingControlPlaneId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetManagingControlPlaneId gets a reference to the given NullableString and assigns it to the ManagingControlPlaneId field.
func (o *SiteUpdate) SetManagingControlPlaneId(v string) {
	o.ManagingControlPlaneId.Set(&v)
}
// SetManagingControlPlaneIdNil sets the value for ManagingControlPlaneId to be an explicit nil
func (o *SiteUpdate) SetManagingControlPlaneIdNil() {
	o.ManagingControlPlaneId.Set(nil)
}
...
func (o *SiteUpdate) UnsetManagingControlPlaneId() {
	o.ManagingControlPlaneId.Unset()
}
...
func (o SiteUpdate) MarshalJSON() ([]byte, error) {
	...
	if o.ManagingControlPlaneId.IsSet() {
		toSerialize["managingControlPlaneId"] = o.ManagingControlPlaneId.Get()
	}
	if o.Attributes != nil {
...
func (o *SiteUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "managingControlPlaneId")
