...
type BillingCycleAllOf struct {
	...
	LastBilledOn *time.Time `json:"lastBilledOn,omitempty"`
	NextBilledOn *time.Time `json:"nextBilledOn,omitempty"`
...
// SetLastBilledOn gets a reference to the given time.Time and assigns it to the LastBilledOn field.
...
// SetNextBilledOn gets a reference to the given time.Time and assigns it to the NextBilledOn field.
