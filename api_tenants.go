...
func (r ApiCreateTenantRequest) Execute() (Tenant, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return Tenant
 */
func (a *TenantsApiService) CreateTenantExecute(r ApiCreateTenantRequest) (Tenant, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.tenantCreate == nil {
		executionError.error = "tenantCreate is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiDeleteTenantRequest) Execute() (*_nethttp.Response, GenericOpenAPIError) {
 ...
 * Execute executes the request
 */
func (a *TenantsApiService) DeleteTenantExecute(r ApiDeleteTenantRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetTenantRequest) Execute() (Tenant, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return Tenant
 */
func (a *TenantsApiService) GetTenantExecute(r ApiGetTenantRequest) (Tenant, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetTenantsListRequest) Execute() ([]Tenant, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return []Tenant
 */
func (a *TenantsApiService) GetTenantsListExecute(r ApiGetTenantsListRequest) ([]Tenant, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarFormParams := _neturl.Values{}
	if r.ids == nil {
		executionError.error = "ids is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiGetTenantsPageRequest) Execute() (TenantsPage, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return TenantsPage
 */
func (a *TenantsApiService) GetTenantsPageExecute(r ApiGetTenantsPageRequest) (TenantsPage, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateTenantRequest) Execute() (Tenant, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return Tenant
 */
func (a *TenantsApiService) UpdateTenantExecute(r ApiUpdateTenantRequest) (Tenant, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.tenantUpdate == nil {
		executionError.error = "tenantUpdate is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
