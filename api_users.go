...
func (r ApiCreateUserRequest) Execute() (User, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return User
 */
func (a *UsersApiService) CreateUserExecute(r ApiCreateUserRequest) (User, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.userCreate == nil {
		executionError.error = "userCreate is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
 ...
 * Execute executes the request
 */
func (a *UsersApiService) DeleteUserExecute(r ApiDeleteUserRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetCurrentUserRequest) Execute() (User, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return User
 */
func (a *UsersApiService) GetCurrentUserExecute(r ApiGetCurrentUserRequest) (User, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetUserRequest) Execute() (User, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return User
 */
func (a *UsersApiService) GetUserExecute(r ApiGetUserRequest) (User, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetUsersPageRequest) Execute() (UsersPage, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return UsersPage
 */
func (a *UsersApiService) GetUsersPageExecute(r ApiGetUsersPageRequest) (UsersPage, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateUserRequest) Execute() (User, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return User
 */
func (a *UsersApiService) UpdateUserExecute(r ApiUpdateUserRequest) (User, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	localVarFormParams := _neturl.Values{}
	if r.userUpdate == nil {
		executionError.error = "userUpdate is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiUpdateUserPasswordRequest) Execute() (*_nethttp.Response, GenericOpenAPIError) {
 ...
 * Execute executes the request
 */
func (a *UsersApiService) UpdateUserPasswordExecute(r ApiUpdateUserPasswordRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if r.updatePassword == nil {
		executionError.error = "updatePassword is required and must be specified"
		return nil, executionError
	}
